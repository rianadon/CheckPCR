 ...
 */
export function send(url, respType, headers, data, progress) {
 ...
 */
export function element(tag, cls, html, id) {
 ...
 */
export function _$(arg) {
    if (arg == null)
        throw new Error('Expected argument to be non-null');
    return arg;
}
export function _$h(arg) {
    if (arg == null)
        throw new Error('Expected node to be non-null');
    return arg;
}
export function localStorageRead(name, defaultVal) {
    try {
...
export function localStorageWrite(name, item) {
...
export function requestIdleCallback(cb, opts) {
...
const FULLMONTHS = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October',
    'November', 'December'];
export function dateString(date, addThis = false) {
    if (date === 'Forever')
        return date;
...
export function smoothScroll(to) {
    return new Promise((resolve, reject) => {
        let start = null;
