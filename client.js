...
var a, ac, act, activity, activityTypes, addActivity, athenaData, attachmentify, c, cc, closeNews, closeOpened, color, d, dateString, display, dologin, done, dragTarget, dt, e, el, element, enabled, fetch, findId, firstTime, formatUpdate, fullMonths, getCookie, getResizeAssignments, gp, hammertime, headroom, hex2rgb, input, intervalRefresh, labrgb, lastAthena, list, listName, loginHeaders, loginURL, menuOut, mimeTypes, months, navToggle, p, palette, parse, parseDateHash, pe, resize, rgb2hex, ripple, scroll, send, separate, setCookie, smoothScroll, snackbar, sp, tab, type, tzoff, up, updateAvatar, updateColors, updateSelectNum, urlify, viewData, weekdays, _fn, _fn1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s,
...
fetch = function() {
  if (location.protocol === "chrome-extension:") {
    ...
    send("https://webappsca.pcrsoft.com/Clue/Student-Assignments-End-Date-Range/7536", "document", null, null, true).then(function(resp) {
      var e, t, up, _i, _len, _ref;
      console.timeEnd("Fetching assignments");
      if (resp.responseURL.indexOf("Login") !== -1) {
        loginURL = resp.responseURL;
        _ref = resp.response.getElementsByTagName("input");
...
findId = function(element, tag, id) {
  var e, _i, _len, _ref;
  _ref = element.getElementsByTagName(tag);
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    e = _ref[_i];
...
parse = function(doc) {
  var ap, assignment, assignments, b, c, ca, classes, d, divs, e, handledDataShort, pos, range, t, title, _i, _j, _k, _l, _len, _len1, _len2, _len3, _m, _ref, _ref1;
  ...
  _ref = doc.getElementsByTagName("input");
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    e = _ref[_i];
  ...
  for (_k = 0, _len2 = assignments.length; _k < _len2; _k++) {
    ...
    _ref1 = window.data.classes;
    for (pos = _m = 0, _len3 = _ref1.length; _m < _len3; pos = ++_m) {
      c = _ref1[pos];
...
dateString = function(date, addThis) {
  var r, relative, today, _i, _len, _ref;
  if (addThis == null) {
    addThis = false;
  }
  ...
  today = new Date();
  if ((0 < (_ref = (date.getTime() - today.getTime()) / 1000 / 3600 / 24) && _ref <= 6)) {
...
addActivity = function(type, assignment, newActivity) {
  ...
  if (_ref = assignment.id, __indexOf.call(done, _ref) >= 0) {
...
display = function() {
  var already, assignment, attachment, attachments, close, complete, d, date, day, dayTable, e, end, found, id, lastAssignments, link, main, month, n, name, nextSat, num, oldAssignment, pos, previousAssignments, s, separated, smallTag, span, spanRelative, split, start, startSun, taken, te, times, today, todayDiv, todaySE, tr, weekHeights, weekId, wk, year, _fn, _fn1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
  ...
  if (window.data.monthView) {
    start = Math.min.apply(Math, (function() {
      ...
      _ref = window.data.assignments;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        assignment = _ref[_i];
        _results.push(assignment.start);
      }
      return _results;
    })());
  ...
  split = [];
  _ref1 = window.data.assignments;
  for (num = _k = 0, _len1 = _ref1.length; _k < _len1; num = ++_k) {
    assignment = _ref1[num];
    ...
    if (lastAssignments != null) {
      found = false;
      for (num = _l = 0, _len2 = lastAssignments.length; _l < _len2; num = ++_l) {
  ...
  weekHeights = {};
  previousAssignments = {};
  _ref2 = document.getElementsByClassName("assignment");
  ...
  _fn = function(id) {
    return complete.addEventListener("mouseup", function(evt) {
      var added, el, elem, _len6, _p, _ref3;
      if (evt.which === 1) {
        el = evt.target;
        ...
        if (document.body.getAttribute("data-view") === "1") {
          setTimeout(function() {
            var elem, _len6, _p, _ref3;
            _ref3 = document.querySelectorAll(".assignment[id*=\"" + id + "\"], .upcomingTest[id*=\"test" + id + "\"], .activity[id*=\"activity" + id + "\"]");
            for (_p = 0, _len6 = _ref3.length; _p < _len6; _p++) {
              elem = _ref3[_p];
  ...
  for (_o = 0, _len5 = split.length; _o < _len5; _o++) {
    s = split[_o];
    ...
    if (_ref3 = assignment.id, __indexOf.call(done, _ref3) >= 0) {
    ...
    if (assignment.attachments.length > 0) {
      ...
      _ref4 = assignment.attachments;
      _fn1 = function(attachment) {
        var a, req;
    ...
    if (assignment.baseType === "test" && assignment.start >= today) {
      ...
      if (_ref5 = assignment.id, __indexOf.call(done, _ref5) >= 0) {
        te.classList.add("done");
      }
...
ripple = function(el) {
  ...
  el.addEventListener("mouseup", function(evt) {
    var target, wave, waves, _fn, _i, _len;
    if (evt.which === 1) {
      target = evt.target.classList.contains("wave") ? evt.target.parentNode : evt.target;
...
_ref = document.querySelectorAll("#navTabs>li");
for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  tab = _ref[_i];
  tab.addEventListener("click", function(evt) {
    var assignment, assignments, columnHeights, columns, index, start, step, trans, w, widths, _j, _k, _len1, _len2, _ref1;
    ...
    if (document.body.getAttribute("data-view") === "1") {
      ...
      if (trans) {
        ...
        columns = null;
        for (index = _j = 0, _len1 = widths.length; _j < _len1; index = ++_j) {
          w = widths[index];
        ...
        columnHeights = (function() {
          var _k, _results;
          _results = [];
          for (_k = 0; 0 <= columns ? _k < columns : _k > columns; 0 <= columns ? _k++ : _k--) {
            _results.push(0);
          }
          return _results;
        })();
        step = function(timestamp) {
          var assignment, col, n, _k, _len2;
          if (start == null) {
            start = timestamp;
          }
          for (n = _k = 0, _len2 = assignments.length; _k < _len2; n = ++_k) {
      ...
      _ref1 = document.getElementsByClassName("assignment");
...
_ref1 = document.querySelectorAll("#infoTabs>li");
...
resize = function() {
  var assignment, assignments, col, columnHeights, columns, index, n, w, widths, _k, _l, _len2, _len3;
  widths = document.body.classList.contains("showInfo") ? [650, 1100, 1800, 2700, 3800, 5100] : [350, 800, 1500, 2400, 3500, 4800];
  columns = null;
  for (index = _k = 0, _len2 = widths.length; _k < _len2; index = ++_k) {
    w = widths[index];
    if (window.innerWidth > w) {
      columns = index + 1;
    }
  ...
  columnHeights = (function() {
    var _l, _results;
    _results = [];
    for (_l = 0; 0 <= columns ? _l < columns : _l > columns; 0 <= columns ? _l++ : _l--) {
      _results.push(0);
    }
    return _results;
  })();
  assignments = getResizeAssignments();
  for (n = _l = 0, _len3 = assignments.length; _l < _len3; n = ++_l) {
    assignment = assignments[n];
    col = n % columns;
    assignment.style.top = columnHeights[col] + "px";
    assignment.style.left = 100 / columns * col + "%";
  ...
  setTimeout(function() {
    var _len4, _m;
    for (n = _m = 0, _len4 = assignments.length; _m < _len4; n = ++_m) {
      assignment = assignments[n];
      col = n % columns;
      if (n < columns) {
        columnHeights[col] = 0;
...
_ref2 = document.querySelectorAll("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search]");
...
labrgb = function(_L, _a, _b) {
  var dot_product, f_inv, from_linear, lab_e, lab_k, m, n, ref_X, ref_Y, ref_Z, tuple, var_x, var_y, var_z, _B, _G, _R, _X, _Y, _Z;
  ref_X = 0.95047;
  ref_Y = 1.00000;
  ref_Z = 1.08883;
  lab_e = 0.008856;
...
if (location.protocol === "chrome-extension:" && Date.now() - lastAthena >= 1000 * 3600 * 24 && (navigator.onLine || (navigator.onLine == null)) && (localStorage["noSchoology"] == null)) {
  ...
  send("https://athena.harker.org/iapi/course/active", "json").then(function(resp) {
    var course, courseDetails, n, _l, _len3, _ref3;
    if (resp.responseURL.indexOf("login") !== -1) {
      ...
      if (resp.response.response_code === 200) {
        _ref3 = resp.response.body.courses.courses;
        for (n = _l = 0, _len3 = _ref3.length; _l < _len3; n = ++_l) {
          course = _ref3[n];
...
if ((localStorage["data"] != null) && (localStorage["classColors"] == null)) {
  a = {};
  _ref3 = JSON.parse(localStorage["data"]).classes;
...
if (localStorage["data"] != null) {
  _ref4 = JSON.parse(localStorage["data"]).classes;
...
_ref5 = document.getElementsByClassName("colors");
for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
  e = _ref5[_n];
  _ref6 = e.getElementsByTagName("div");
  _fn = function(sp, color, list, listName) {
  ...
  for (_o = 0, _len6 = _ref6.length; _o < _len6; _o++) {
    ...
    _fn(sp, color, list, listName);
  }
}

updateColors = function() {
  var mix, name, sheet, style, _ref7, _ref8, _results, _results1;
  mix = function(a, b, p) {
    var hex, rgbA, rgbB;
    rgbA = hex2rgb(a);
    rgbB = hex2rgb(b);
  ...
  if (localStorage["colorType"] === "assignment") {
    _ref7 = JSON.parse(localStorage["assignmentColors"]);
    _results = [];
    for (name in _ref7) {
      color = _ref7[name];
      ...
      _results.push(sheet.insertRule(".assignmentItem." + name + ".done>i { background-color: " + palette[color] + "; }", 0));
    }
    return _results;
  } else {
    _ref8 = JSON.parse(localStorage["classColors"]);
    _results1 = [];
    for (name in _ref8) {
      color = _ref8[name];
      ...
      _results1.push(sheet.insertRule(".assignmentItem[data-class=\"" + name + "\"].done>i { background-color: " + palette[color] + "; }", 0));
    }
    return _results1;
  }
};
...
_ref7 = document.getElementsByClassName("settingsControl");
...
_ref8 = document.getElementsByName("colorType");
...
if (localStorage["data"] != null) {
  ...
  if (localStorage["activity"] != null) {
    ...
    for (_r = 0, _len9 = activity.length; _r < _len9; _r++) {
      act = activity[_r];
...
if (location.protocol !== "chrome-extension:") {
  ...
  _ref9 = up.childNodes;
  for (_s = _ref9.length - 1; _s >= 0; _s += -1) {
    el = _ref9[_s];
...
send("https://api.github.com/gists/b42a5a3c491be081e9c9", "json").then(function(resp) {
  ...
  window.getNews = function(onfail) {
    return send(resp.response.files["updates.htm"].raw_url).then(function(resp) {
      var news, _len10, _ref10, _t;
      localStorage["newsCommit"] = nc;
      _ref10 = resp.responseText.split("<hr>");
      for (_t = 0, _len10 = _ref10.length; _t < _len10; _t++) {
        news = _ref10[_t];
