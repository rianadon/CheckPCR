    ...
    display = ->
      ...
      while d <= end
        ...
        if wk.getElementsByClassName("day").length <= d.getDay()
          ...
          day.classList.add "today" if Math.floor((d-tzoff)/1000/3600/24) is today

          # Since this is being positioned above the assignments, click events have to pass through to the assignment
...
Therefore, a listener is attached to the resizing of the browser window.
    ...
    resize = ->
      ...
      assignments.sort (a,b) ->
        b.getElementsByClassName("body")[0].innerText.length-a.getElementsByClassName("body")[0].innerText.length
